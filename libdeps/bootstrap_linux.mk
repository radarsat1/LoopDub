...
#	This script can be pointed to the dsound header.
	echo "StaticLibrary('rtaudio', ['RtAudio.cpp'], CCFLAGS='-D__LINUX_ALSASEQ__')" >$(PKG_RTAUDIO_DIR)/SConstruct
...
#	Replace the RtMidi build system with Scons.
	echo "StaticLibrary('rtmidi', ['RtMidi.cpp'], CCFLAGS='-D__LINUX_ALSA__')" >$(PKG_RTMIDI_DIR)/SConstruct
